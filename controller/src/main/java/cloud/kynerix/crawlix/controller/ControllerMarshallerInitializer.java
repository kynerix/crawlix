...
@AutoProtoSchemaBuilder(includeClasses = {WorkerNode.class, CrawlingJob.class, Plugin.class, Workspace.class, Content.class, VisitedURL.class}, schemaPackageName = "crawlix", schemaFileName = "Crawlix.proto")
